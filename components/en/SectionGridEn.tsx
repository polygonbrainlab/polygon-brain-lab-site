...
const sections: SectionItem[] = [
  {
    ...
    description:
      "Mini apps to explore attention, memory, executive functions, language, and processing speed. Clear instructions, explicit variables, honest limitations.",
    status: "in progress",
    icon: <ToolIcon />,
  },
  {
    ...
    description:
      "Downloadable materials, task design templates, checklists, and difficulty graduation guides. Designed for real session work.",
    status: "in progress",
    icon: <ResourceIcon />,
  },
  {
    id: "open-lab",
    label: "Open Lab",
    title: "Code and open documentation",
    description:
      "Repositories, technical docs, public roadmap, and reusable prototypes. Open-source as an engine of trust, not a marketing argument.",
    status: "beta",
    icon: <LabIcon />,
  ...
  },
  {
    ...
    title: "Critical thinking on cognition",
    description:
      "Short, rigorous articles on brain training limits, functional transfer, gamification, AI in health, and responsible tool design.",
    status: "in progress",
    icon: <CritiqueIcon />,
  },
];
...
function SectionCard({ item }: { item: SectionItem }) {
  const isAccent = item.status === "available" || item.status === "beta";
